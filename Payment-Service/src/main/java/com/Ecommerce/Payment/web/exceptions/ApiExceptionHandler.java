...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> paymentNotFoundException(RuntimeException ex, HttpServletRequest request) {
        log.error("api error - ", ex);
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public ResponseEntity<ErrorMessage> invalidPaymentException(RuntimeException ex, HttpServletRequest request) {
        log.error("api error - ", ex);
        return ResponseEntity
