package com.Ecommerce.Catalog.web.exceptions;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> productNotFoundException(RuntimeException ex, HttpServletRequest request) {
        log.error("api error - ", ex);
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .contentType(MediaType.APPLICATION_JSON)
